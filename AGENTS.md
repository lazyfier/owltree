...
- Do not hardcode placeholder social URLs in `Footer.tsx`
- Empty optional social env vars should hide the corresponding icon
...
- The Vite dev server should refresh this metadata when watched note or project source files change
